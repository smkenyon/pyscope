...
This package has been generated by CLAUDE - human-verification and rewrites have only been performed on a few of the examples. In the coming days, I will verify and refactor a majority of the code. The below README is also *mostly* autogenerated. The main goal here is to get nvtx-like decorator annotations and event "guards" - to profile individual pieces of code with Hardware resource monitoring.
